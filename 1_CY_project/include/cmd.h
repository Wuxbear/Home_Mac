...
enum DAEMON_CMD_ID {
	...
	CMD_ID_POWER_ON_ALARM = 0x02,
	CMD_ID_POWER_OFF_TIME = 0x03,
	CMD_ID_MCU_RESET = 0x04,

	CMD_ID_MCU_SET_DATA_ADDR = 0x10,
	CMD_ID_MCU_SET_EXT_MENU = 0x11,

	CMD_ID_MCU_SPI_FLASH_ERASE = 0x20,
	CMD_ID_MCU_SPI_FLASH_WRITE = 0x21,
	CMD_ID_DATA_CHECK = 0x22,

	CMD_ID_OLED_CLEAN = 0x30,
	CMD_ID_OLED_TEXT_OUT = 0x31,
	CMD_ID_OLED_IMAGE_OUT = 0x32,
	CMD_ID_OLED_RESET = 0x32,

	CMD_ID_RTC_SETUP = 0x40,

	CMD_ID_GPIO_DIRECTION_SETUP = 0x50,
	CMD_ID_GPIO_VALUE_SETUP = 0x51,

	CMD_ID_MCU_XPORT = 0x60,

	CMD_ID_I2C_MASTER_SEND = 0x70,

	CMD_ID_MCU_STATUS_CHANGE = 0xC0,
	CMD_ID_MCU_EXT_MENU = 0xC1,
	CMD_ID_BOOT_ARGUMENT = 0xC2,

	CMD_ID_MCU_SELF_TEST = 0xE0,
